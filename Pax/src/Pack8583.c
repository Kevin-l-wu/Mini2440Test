...
static int PackElement(const FIELD_ATTR *pAttr, const uchar *pusIn, uchar *pusOut,
                        uint *puiOutLen);
static int UnPackElement(const FIELD_ATTR *pAttr, const uchar *pusIn, uchar *pusOut,
                        uint *puiInLen);
...
int PubPack8583(const FIELD_ATTR *pDataAttr, const void *pSt8583, uchar *pusOut, uint *puiOutLen)
{
	int     iRet;
...
/****************************************************************************
 ...
 Return Code:
    ...
    < 0             length overflow
****************************************************************************/
int PackElement(const FIELD_ATTR *pAttr, const uchar *pusIn, uchar *pusOut,
                 uint *puiOutLen)
{
