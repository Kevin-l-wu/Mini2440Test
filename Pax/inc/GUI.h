...
//				>=0	 timeoutSec Second(s)
//************************************
int Gui_ShowInputBox(const unsigned char *pszTitle, GUI_TEXT_ATTR stTitleAttr, const unsigned char *pszPrompt, 
	GUI_TEXT_ATTR stPromptAttr, unsigned char *pszContent, GUI_TEXT_ATTR stContentAttr, const GUI_INPUTBOX_ATTR *pstAttr, int timeoutSec);
...
//				>=0	 timeoutSec Second(s)
//************************************
int Gui_ShowTimeBox(const unsigned char *pszTitle, GUI_TEXT_ATTR stTitleAttr, unsigned char *pszTime, 
	GUI_TEXT_ATTR stContentAttr, unsigned char isTime, int timeoutSec);
...
//************************************
int Gui_BindMenu(const unsigned char *psztitle, GUI_TEXT_ATTR stTitleAttr, GUI_TEXT_ATTR stTextAttr, 
	const GUI_MENUITEM *pstMenuItem, GUI_MENU *pstMenu);
...
int Gui_ShowAlternative(const unsigned char *pszTitle, GUI_TEXT_ATTR stTitleAttr, 
	const unsigned char *pszPrompt, GUI_TEXT_ATTR stContentAttr, const unsigned char *pszOption1, 
	int iValue1, const unsigned char *pszOption2, int iValue2, int timeoutSec, int *piSelOption);
