...
#define EDC_VER_PUB		    "1.02"			// Public version number
#define EDC_VER_INTERN	    "1.02.01"		// Extend version number. should be same as EDC_VER_INTERN's heading.
// Added by Kim 20150120
#define EDC_BASE_VER_INTERN     "1.02.01"   // EDC version, please do not modify
...
#include "ClssApiMC.h"
#include "ClssApiPBOC.h"
#include "ClssApiAE.h"			//added by kevinliu 2015/10/16
#include "ClssApiJCB.h"
#include "ClssApiDPAS.h"		//added by Gillian 2015/12/1
#endif
...
#define CHARSET_WEST 	"/Font/west"
#define CHARSET_GB2312 	"/Font/west"
#define CHARSET_BIG5 	"/Font/west"
#define CHARSET_VIETNAM "/Font/west"
#define CHARSET_SHIFT_JIS "/Font/west"
#define CHARSET_KOREAN 	"/Font/west"
#define CHARSET_ARABIA 	"/Font/west"
...
//extern int vsprintf_string(char *buffer, const char *format, va_list argptr);
