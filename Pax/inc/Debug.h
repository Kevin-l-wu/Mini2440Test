...
// print string debug information
#define PubTRACE0(sz) {ScrCls();ScrGotoxy(0,0);Lcdprintf_string(sz);PubWaitKey(_POS_DEBUG_WAIT);}
#define PubTRACE1(sz, p1) {ScrCls();ScrGotoxy(0,0);Lcdprintf_string(sz, p1);PubWaitKey(_POS_DEBUG_WAIT);}	   
#define PubTRACE2(sz, p1, p2) {ScrCls();ScrGotoxy(0,0);Lcdprintf_string(sz, p1, p2);PubWaitKey(_POS_DEBUG_WAIT);}
#define PubTRACE3(sz, p1, p2, p3) {ScrCls();ScrGotoxy(0,0);Lcdprintf_string(sz,p1,p2,p3);PubWaitKey(_POS_DEBUG_WAIT);}
